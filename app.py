...
# Import Data
data = pd.read_csv(r"D:\Suraj Personal\ExcelR Project\Data")
data.drop(columns=['Unnamed: 0'], inplace=True)
Forecast_df = pd.read_csv("D:\Suraj Personal\ExcelR Project\Forecasts")
Forecast_df.drop(columns=['Unnamed: 0'], inplace=True)

# Load the saved model
with open(r"C:\Users\Suraj\ExcelR Projects\Model.pkl", 'rb') as model_file:
